...
//default constructor
YGOCard::YGOCard():name_{""}, type_{""}, level_rank_{0}, race_{""}, 
                  attribute_{""}, atk_{0}, def_{0}
{
}

//parameterized constructor		
YGOCard::YGOCard(std::string name, std::string type, int level, std::string race, std::string attribute, int atk, int def):
                name_{name}, type_{type}, level_rank_{level}, race_{race},
                attribute_{attribute}, atk_{atk}, def_{def}
{ 
}
